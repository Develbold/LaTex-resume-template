...
\highlightbar{
    ...
    \vspace{0.5em}
    \homepage{hanswurst.com}{https://www.hanswurst.de}
    \github{@hanswurst}{https://github.com/giantmolecularcloud}
    \linkedin{Hans Wurst}{https://www.linkedin.com/in/hanswurst/}
    \noticeperiod{notice date/period}
...
\mainbar{
    ...
    % a section on voluntary work
    \section[\faGroup]{Voluntary Work}
    \job{date}
